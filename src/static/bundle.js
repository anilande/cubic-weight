...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(_AppRoutes2.default, null), document.getElementById('appContainer'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data2 = __webpack_require__(72);
	...
	var API_PATH = "/api/products";
	
	var AvgCubicWeight = function (_Component) {
	    _inherits(AvgCubicWeight, _Component);
	
	    function AvgCubicWeight() {
	        _classCallCheck(this, AvgCubicWeight);
	
	        var _this = _possibleConstructorReturn(this, (AvgCubicWeight.__proto__ || Object.getPrototypeOf(AvgCubicWeight)).apply(this, arguments));
	
	        _this.catch = [];
	
	        _this.pageNo = 1;
	
	        _this.data = _data3.default.objects;
	
	        _this.dataUrl = API_PATH + "/1";
	
	        _this.paggingState = 'next';
	
	        _this.state = {
	            itemsList: _data3.default.objects,
	            showNext: true,
	            showPrev: false
	        };
	
	        _this.nextUpdate = _this.nextUpdate.bind(_this);
	        _this.prevUpdate = _this.prevUpdate.bind(_this);
	        _this.applyFilters = _this.applyFilters.bind(_this);
	        _this.getCategoryList = _this.getCategoryList.bind(_this);
	        return _this;
	    }
	
	    _createClass(AvgCubicWeight, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            fetch(this.dataUrl).then(function (response) {
	                ...
	                self.dataUrlNext = _data3.default.next;
	                self.catch[self.pageNo] = { url: self.dataUrl, data: _data3.default };
	                self.setData(_data3.default.objects, true, false);
	                self.pageNo++;
	            });
	        }
	    }, {
	        ...
	        value: function getCategoryList() {
	            ...
	            return [].concat(_toConsumableArray(new Set(catList))).sort();
	        }
	    }, {
	        key: 'setData',
	        value: function setData(data, next, prev) {
	            this.data = data;
	        ...
	        value: function nextUpdate() {
	            ...
	            if (this.dataUrlNext !== null) {
	                ...
	                if (this.catch[this.pageNo]) {
	                    ...
	                    fetch(this.dataUrlNext).then(function (response) {
	                        return response.json();
	                    }).then(function (data) {
	                        self.catch[self.pageNo] = { url: self.dataUrlNext, data: data };
	        ...
	        value: function prevUpdate() {
	            ...
	            if (this.catch[previousPage]) {
	                var _data = this.catch[previousPage].data;
	                if (previousPage <= 1) {
	                    this.setData(_data.objects, true, false);
	                } else {
	                    this.pageNo--;
	                    this.paggingState = 'prev';
	                    this.setData(_data.objects, true, true);
	                }
	                this.dataUrlNext = _data.next;
	            } else {
	                fetch(API_PATH + this.catch[previousPage].url).then(function (response) {
	                    return response.json();
	                }).then(function (data) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'app-page' },
	                _react2.default.createElement(_filter2.default, { options: this.getCategoryList(), onChange: this.applyFilters }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'lists-wrapper' },
	                    _react2.default.createElement(_list2.default, { itemsList: data })
	                ),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'prev' },
	                    this.state.showPrev ? _react2.default.createElement(_page2.default, { nextPage: this.prevUpdate, label: 'prev' }) : null
	                ),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'next' },
	                    this.state.showNext ? _react2.default.createElement(_page2.default, { nextPage: this.nextUpdate, label: 'next', className: 'next' }) : null
	                )
	            );
	        }
	    }]);
	...
	exports.default = AvgCubicWeight;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _listItem = __webpack_require__(71);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                itemsList.map(function (item, index) {
	                    return _react2.default.createElement(_listItem2.default, { key: index, item: item });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItem = function (_Component) {
	    ...
	    _createClass(ListItem, [{
	        key: 'cubicWeight',
	        value: function cubicWeight(size) {
	            var conversion_factor = 250;
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'td',
	                                null,
	                                item.size.width + "cm X " + item.size.length + "cm X " + item.size.height + "cm"
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'tr',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filter = function (_Component) {
	    ...
	    function Filter() {
	        ...
	        var _this = _possibleConstructorReturn(this, (Filter.__proto__ || Object.getPrototypeOf(Filter)).apply(this, arguments));
